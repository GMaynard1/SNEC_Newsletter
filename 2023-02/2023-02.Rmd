...
<font size="12"> **SNEC Newsletter** </font>

![SNEC Logo](../Stock/SNEC.jpg){width=100px}
<font size="7"> *`r Sys.Date()` * </font>
...
![SNEC volunteers made the meeting possible](meeting_crew.jpg){width=400px}
...
![Rachel Pomerleau](Rachel Pomerleau.jpg){width=150px}
![Meeting Logo](Boston2023_Logo_JPEG_edited.jpg){width=300px}
...
<center>
![Asha Ajmani](aa.png){width=200px}
</center>
...
<center>
![Katrina Zarella Smith](kzs.png){width=200px}
</center>
...
![Plankton pumping](Nichols_pump.jpg){width=250px}
![microscope pic](cs_scope.JPG){width=222px}

![Pump truck at sunset](cs_sunset.JPG){width=475px}

*The CCS Toyota Tacoma often served as a mobile plankton laboratory this summer. A pump sampler designed and built by Marine Fisheries Research Director Owen Nichols operated off the truck’s battery, filtering plankton from hundreds of gallons of water.*
...
![Matt Devine talks to students about salmon](Devine_kids.JPG){width=315px}
![Students help move fish to the river](moving_fish.JPG){width=162px}

![Group photo of students and staff with stocking truck](happy campers.JPG){width=485px}
